                                    ...
                                    @foreach ($sellProducts as $sellProduct)
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    href="{{ route('shop.product.details', ['product_slug' => $sellProduct->slug]) }}">
                                                    <img loading="lazy"
                                                        src=" {{ asset('uploads/products') }}/{{ $sellProduct->image }}"
                                            ...
                                            <div class="pc__info position-relative">
                                                <h6 class="pc__title"><a
                                                        href="{{ route('shop.product.details', ['product_slug' => $sellProduct->slug]) }}">{{ $sellProduct->name }}</a>
                                                </h6>
                                                <div class="product-card__price d-flex">
                                                    <span class="money price text-secondary">
                                                        @if ($sellProduct->sale_price)
                                                            <s>Rs.{{ $sellProduct->regular_price }}</s>
                                                            Rs.{{ $sellProduct->sale_price }}
                                                        @else
                                                            Rs.{{ $sellProduct->regular_price }}
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
                    ...
                    @foreach ($featuredProducts as $featuredProduct)
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a
                                        ...
                                        <img loading="lazy"
                                            ...
                                            width="330" height="400" alt="{{ $featuredProduct->name }}"
                                            class="pc__img">
                                    </a>
                                </div>
                                ...
                                <div class="pc__info position-relative">
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', ['product_slug' => $featuredProduct->slug]) }}">{{ $featuredProduct->name }}</a>
                                    </h6>
                                    <div class="product-card__price d-flex align-items-center">
                                        <span class="money price text-secondary">
                                            @if ($featuredProduct->sale_price)
                                                <s>Rs.{{ $featuredProduct->regular_price }}</s>
                                                Rs.{{ $featuredProduct->sale_price }}
                                            @else
                                                Rs.{{ $featuredProduct->regular_price }}
                                            @endif
                                        </span>
                                    </div>
                                </div>
