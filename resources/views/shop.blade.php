...
@section('content')
    <style>
        ...
        .category-list li .chk-category {
            ...
            height: 1rem;
            color: #e4e4e4;
            border: 0.124rem solid currentColor;
            border-radius: 0;
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="1" data-slider-max="2000" data-slider-step="5"
                                data-slider-value="[{{ $min_price }}, {{ $max_price }}]" data-currency="Rs." />
                            <div class="price-range__info d-flex align-items-center mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="price-range__max">Rs.2000</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Page Size" style="margin-right: 20px;" name="pagesize" id="pagesize">
                                    ...
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            ...
                                            <button
                                                ...
                                                data-aside="cartDrawer" type="submit" title="Add To Cart">Add To
                                                Cart</button>
                                        </form>
                                    @endif
                                </div>
